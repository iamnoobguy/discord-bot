...
T = TypeVar("T")
BotT = TypeVar("BotT", bound="BaseBot")
...
class Paginator(Generic[T, BotT], BaseView, abc.ABC):
    """Pagination based on given list"""
    ...
    def __init__(
        ...
        *,
        ...
        self.bot: Optional[BotT] = target and (  # type: ignore
